...
export default function Work(){
    ...
    <>
        ...
        <div className='workLinks'>
            ...
            <Popup contentStyle={{background: "rgb(50, 50, 50)", border: "2px solid white", height:"50%",width: "100%"}} trigger={<button className='innerWork'>Ski Coach<br/><br/>Winter Park Ski Resort</button>}>
            <div className='popDiv'>
                <h2 className='wp'>Freestyle Ski Coach</h2>
            ...
            <Popup contentStyle={{background: "rgb(50, 50, 50)", border: "2px solid white", height:"50%",width: "100%"}} trigger={<button className='innerWork'>Boat Captain<br/><br/>Buckhorn Ridge Outfitters</button>}>
            <div className='popDiv'>
                <h2 className='wp'>Charter Boat Captain</h2>
                <p className='popDescription'>
            ...
            <Popup contentStyle={{background: "rgb(50, 50, 50)", border: "2px solid white", height:"50%",width: "100%"}} trigger={<button className='innerWork'>Track Marshall<br/><br/>Urban Air</button>}>
                <div className='popDiv'>
                    <h2 className='urban'>Track Marshall / Shift Lead</h2>
                    <p className='popDescription'>
            ...
            <Popup contentStyle={{background: "rgb(50, 50, 50)", border: "2px solid white", height:"50%",width: "100%"}} trigger={<button className='innerWork'>Pool Manager<br/><br/>Hiwan Country Club</button>}>
                <div className='popDiv'>
                    <h2 className='urban'>Pool Manager</h2>
                    <p className='popDescription'>
